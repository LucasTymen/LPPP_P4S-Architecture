    ...
    <div className="min-h-screen bg-[#0d0d0d] text-[#e6e6e6] p-4 md:p-8">
      <main className="max-w-[720px] mx-auto">
        <section className="text-center py-8 md:py-12">
          <h1 className="text-xl md:text-2xl font-semibold mb-2">{CONTENT.hero_title}</h1>
        ...
        <section className="bg-[#1a1a1a] rounded-lg p-4 mb-6">
          ...
          <p className="text-[#e6e6e6] leading-relaxed">{CONTENT.positionnement}</p>
        </section>
        <section className="bg-[#1a1a1a] rounded-lg p-4 mb-6">
          <h2 className="text-lg font-semibold mb-2">Votre activité & besoins</h2>
          <p className="text-[#e6e6e6] leading-relaxed">{CONTENT.activite_pain_points}</p>
        </section>
        <section className="bg-[#1a1a1a] rounded-lg p-4 mb-6">
          <h2 className="text-lg font-semibold mb-2">Me contacter</h2>
          <p className="text-[#e6e6e6] leading-relaxed">{CONTENT.produit_commercial}</p>
        </section>
      </main>
    </div>
  );
